...
const ENTITY_CONFIGS = {
  ...
  'Case Type': { label: 'Case Type', logic: caseTypeLogic, fields: [{ key: 'name', label: 'Case Type Name', placeholder: 'e.g., Civil' }, { key: 'short_code', label: 'Short Code', placeholder: 'CAST-<CASE-TYPE>', hint: 'Example: CAST-CIVIL-SUIT-I' }, { key: 'status', label: 'Status', default: 'Active' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: { status: 'Active' } },
  Courts: { label: 'Courts', logic: courtsLogic, fields: [{ key: 'name', label: 'Court Name', placeholder: 'e.g., Supreme Court' }, { key: 'short_code', label: 'Short Code', placeholder: 'COUT-<COURT-SORT-CODE>', hint: 'Example: COUT-HIGH-COURT' }, { key: 'status', label: 'Status', default: 'Active' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: { status: 'Active' } },
  'Bench Type': { label: 'Bench Type', logic: benchTypeLogic, fields: [{ key: 'name', label: 'Bench Type Name', placeholder: 'e.g., Single Bench' }, { key: 'short_code', label: 'Short Code', placeholder: 'BENT-<BENCH-TYPE>', hint: 'Example: BENT-DIVISION-BENCH' }, { key: 'status', label: 'Status', default: 'Active' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: { status: 'Active' } },
  Jurisdiction: { label: 'Jurisdiction', logic: jurisdictionLogic, fields: [{ key: 'name', label: 'Jurisdiction Name', placeholder: 'e.g., Delhi' }, { key: 'short_code', label: 'Short Code', placeholder: 'JURT-<JURISDICTION>', hint: 'Example: JURT-CIVIL' }, { key: 'status', label: 'Status', default: 'Active' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: { status: 'Active' } },
  Stage: { label: 'Stage', logic: caseStageLogic, fields: [{ key: 'name', label: 'Stage Name', placeholder: 'e.g., Pleading' }, { key: 'short_code', label: 'Short Code', placeholder: 'CSTT-<CASE-STAGE>', hint: 'Example: CSTT-TRIAL' }, { key: 'status', label: 'Status', default: 'Active' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: { status: 'Active' } },
  Priority: { label: 'Priority', logic: priorityLogic, fields: [{ key: 'name', label: 'Priority Name', placeholder: 'e.g., High' }, { key: 'short_code', label: 'Short Code', placeholder: 'PRIT-<PRIORITY>', hint: 'Example: PRIT-HIGH' }, { key: 'status', label: 'Status', default: 'Active' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: { status: 'Active' } },
