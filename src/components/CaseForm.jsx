...
const ENTITY_CONFIGS = {
  Status: { label: 'Status', logic: caseStatusLogic, fields: [{ key: 'name', label: 'Status Name', placeholder: 'Enter status name' }, { key: 'short_code', label: 'Short Code', placeholder: 'CASS-<CASE-STATUS>', hint: 'Example: CASS-PENDING' }, { key: 'status', label: 'Status', default: 'Active' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: { status: 'Active' } },
  'Case Type': { label: 'Case Type', logic: caseTypeLogic, fields: [{ key: 'name', label: 'Case Type Name', placeholder: 'e.g., Civil' }, { key: 'short_code', label: 'Short Code', placeholder: 'CAST-<CASE-TYPE>', hint: 'Example: CAST-CIVIL-SUIT-I' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: {} },
  Courts: { label: 'Courts', logic: courtsLogic, fields: [{ key: 'name', label: 'Court Name', placeholder: 'e.g., Supreme Court' }, { key: 'short_code', label: 'Short Code', placeholder: 'COUT-<COURT-SORT-CODE>', hint: 'Example: COUT-HIGH-COURT' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: {} },
  'Bench Type': { label: 'Bench Type', logic: benchTypeLogic, fields: [{ key: 'name', label: 'Bench Type Name', placeholder: 'e.g., Single Bench' }, { key: 'short_code', label: 'Short Code', placeholder: 'BENT-<BENCH-TYPE>', hint: 'Example: BENT-DIVISION-BENCH' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: {} },
  Jurisdiction: { label: 'Jurisdiction', logic: jurisdictionLogic, fields: [{ key: 'name', label: 'Jurisdiction Name', placeholder: 'e.g., Delhi' }, { key: 'short_code', label: 'Short Code', placeholder: 'JURT-<JURISDICTION>', hint: 'Example: JURT-CIVIL' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: {} },
  Stage: { label: 'Stage', logic: caseStageLogic, fields: [{ key: 'name', label: 'Stage Name', placeholder: 'e.g., Pleading' }, { key: 'short_code', label: 'Short Code', placeholder: 'CSTT-<CASE-STAGE>', hint: 'Example: CSTT-TRIAL' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: {} },
  Priority: { label: 'Priority', logic: priorityLogic, fields: [{ key: 'name', label: 'Priority Name', placeholder: 'e.g., High' }, { key: 'short_code', label: 'Short Code', placeholder: 'PRIT-<PRIORITY>', hint: 'Example: PRIT-HIGH' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }], defaults: {} },
  ...
  Judge: { label: 'Judge', logic: judgeLogic, fields: [{ key: 'name', label: 'Judge Name', placeholder: 'e.g., Justice Sharma' }, { key: 'short_code', label: 'Short Code', placeholder: 'JUDG-<JUDGE-CODE>', hint: 'Example: JUDG-SK-MOHAPATRA' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }, { key: 'designation', label: 'Designation', placeholder: 'e.g., District & Sessions Judge' }], defaults: {} },
};
