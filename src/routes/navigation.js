  ...
  { type: 'heading', label: 'ADMINISTRATION' },
  {
    ...
    items: [
      ...
      { to: '/admin/roles', label: 'Roles & Permissions', icon: 'lock', module: 'roles' },
      {
        ...
        children: [
          { to: '/admin/database-center/dashboard', label: 'Dashboard', icon: 'grid', module: 'databaseCenter' },
          { to: '/admin/database-center/data-explorer', label: 'Data Explorer', icon: 'search', module: 'databaseCenter' },
          { to: '/admin/database-center/backup-recovery', label: 'Backup & Recovery', icon: 'database', module: 'databaseCenter' },
          { to: '/admin/database-center/import', label: 'Import Center', icon: 'download', module: 'databaseCenter' },
          { to: '/admin/database-center/export', label: 'Export Center', icon: 'upload', module: 'databaseCenter' },
          { to: '/admin/database-center/delete-manager', label: 'Delete Manager', icon: 'trash', module: 'databaseCenter' },
          { to: '/admin/database-center/maintenance', label: 'Maintenance', icon: 'wrench', module: 'databaseCenter' },
          { to: '/admin/database-center/migration', label: 'Migration', icon: 'migrate', module: 'databaseCenter' },
          { to: '/admin/database-center/audit-activity', label: 'Audit & Activity', icon: 'activity', module: 'databaseCenter' },
        ],
      },
      {
        ...
        children: [
          ...
          { to: '/admin/setup-wizard', label: 'Setup Wizard', icon: 'wrench', module: 'setupWizard' },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          { to: '/tools/ai', label: 'AI Assistant', icon: 'bolt', module: 'aiAssistant' },
          { to: '/tools/ai/prompts', label: 'Prompt Library', icon: 'book', module: 'promptLibrary' },
          { to: '/tools/ai/usage', label: 'AI Usage Logs', icon: 'clock', module: 'aiUsage' },
        ],
      },
      {
        label: 'Reports & Analytics', icon: 'grid',
        children: [
          { to: '/tools/reports/cases', label: 'Case Reports', icon: 'folder', module: 'reports' },
          { to: '/tools/reports/courts', label: 'Court Reports', icon: 'folder', module: 'reports' },
          { to: '/tools/reports/activity', label: 'User Activity', icon: 'users', module: 'reports' },
          { to: '/tools/reports/ai-usage', label: 'AI Usage Reports', icon: 'bolt', module: 'reports' },
          { to: '/tools/reports/performance', label: 'Performance Analytics', icon: 'grid', module: 'reports' },
          { to: '/tools/reports/custom', label: 'Custom Reports', icon: 'file', module: 'reports' },
        ],
      },
    ],
  },
