...
import { stripHtml, useFormat, formatDateTime } from '@/utils/format.js';
        ...
        <div className="cl-desktop-view fade-in">
          ...
          {tab === 'history' && (
            <div className="flex-col order-sheet__history-outer">
              {/* Case Select bar inline */}
              <div className="flex align-center gap-12 mb-16 order-sheet__history-select-bar">
                <span className="text-bold text-sm text-soft text-nowrap">Select Case:</span>
                <CaseSelect value={histCaseId} onChange={(val) => loadHistory(val)} />
              </div>

              {!history ? (
                <Card className="order-sheet__history-empty-card"><EmptyState icon="history" title="Select a case to view its history." /></Card>
              ) : (
                <div className="flex-col order-sheet__history-inner">
                  {/* Case Info Header Card */}
                  <div className="order-sheet__case-info-card order-sheet__history-case-info">
                    <div className="order-sheet__case-info-header">
                      <div className="order-sheet__case-icon-box">
                        <Icon name="balance" size={24} />
                      </div>
