    ...
    return nodes.map((item) => {
      ...
      return (
        <Fragment key={item.id}>
          ...
          >
            {bulkMode && <td className="cmp-check-cell"><input type="checkbox" checked={bulkDelSelected.has(item.id)} onChange={() => toggleBulkDel(item.id)} onClick={stopRowDnD} /></td>}
            ...
            <td className="cmp-indent" style={{ '--indent': `${16 + depth * 24}px` }}>
              <div className="cmp-name-cell">
                ...
                <span className="cmp-name-avatar"><Icon name="building" size={15} /></span>
    ...
    <div className="fade-in">
            ...
            {activeAction === 'add' && subMode === 'single' && (
              <div className="cmp-form-grid">
                ...
                <div className="cmp-field">
                  ...
                  <Input value={newCode} placeholder="COUT-HIGH-COURT" onChange={e => setNewCode(e.target.value.toUpperCase())} onKeyDown={e => e.key === 'Enter' && doAdd()} />
              ...
              <div className="cmp-form-grid">
                ...
                {editId && (
                  <>
                    ...
                    <div className="cmp-field">
                      <label className="cmp-label">Short Code <span className="cmp-required">*</span></label>
                      <Input value={editCode} placeholder="COUT-HIGH-COURT" onChange={e => setEditCode(e.target.value.toUpperCase())} />
                      <span className="cmp-hint">Example: COUT-HIGH-COURT</span>
                    </div>
                    <div className="cmp-field cmp-field--full">
                      <label className="cmp-label">Parent Court</label>
      ...
      <div className="cmp-table-card">
        <table className="cmp-table">
          ...
          <tbody>
            {rootItems.length === 0 ? (
              <tr><td className="cmp-empty" colSpan={bulkMode ? 8 : 7}>No courts defined.</td></tr>
