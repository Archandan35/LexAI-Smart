...
const ENTITY_CONFIGS = {
  ...
  Judge: { label: 'Judge', logic: judgeLogic, fields: [{ key: 'name', label: 'Judge Name', placeholder: 'e.g., Justice Sharma' }, { key: 'short_code', label: 'Short Code', placeholder: 'JUDG-SK-MOHAPATRA', hint: 'Example: JUDG-SK-MOHAPATRA' }, { key: 'color', label: 'Color', type: 'color', default: '#6b7280' }, { key: 'designation', label: 'Designation', placeholder: 'e.g., District & Sessions Judge' }, { key: 'status', label: 'Status', default: 'Active', entityLabel: 'status' }], defaults: {} },
};
