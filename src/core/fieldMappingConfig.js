...
const SCHEMAS = {
  ...
  caseHistory: { caseId: 'case_id', createdAt: 'created_at' },
  caseFolders: { ...COMMON, caseId: 'case_id', parentId: 'parent_id' },
  caseActivity: { caseId: 'case_id' },
  auditLogs: { userId: 'user_id', userName: 'user_name' },
  configHistory: { changedBy: 'changed_by' },
